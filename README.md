Docker image for PHP 7.4
========================

Provides a PHP 7.4 docker image based on our [Alpine Linux 3.13 base image](https://github.com/gmitirol/alpine313).
...
test:
  stage: test
  image: gmitirol/alpine313-php74:v1
  artifacts:
    expire_in: 1 hour
